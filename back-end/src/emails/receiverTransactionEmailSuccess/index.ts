export const receiverTransactionEmailSuccess = (
  nameUserSent: string,
                                ...
                                <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; mso-line-height-alt: 18px; color: #555555; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                      <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 21px;"><span style="font-size:14px;">Olá <span id="2462809a-3a5f-4e0c-934a-779e6349f29b" style>${nameUserReceiver}</span>, alguém acabou de te enviar dinheiro. Abaixo estão os dados do enviador.</span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
