...
export function FormLoginAndRegister ({onSubmitData, type, errorApi, isLoad}: IProps) {
  const { 
      register, 
      handleSubmit, 
      formState: { errors },
                    ...
                    <div className="pt-2">
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                <label htmlFor="user_name" className="text-xs font-semibold px-1">Seu nome</label>
                                <div className="flex">
                                    ...
                                    <div className="w-full -ml-10">
                                      <input
                                        ...
                                        <div className="h-2 text-red-500 mb-2 max-[450px]:text-sm">
                                          <p>
                                            {
                                              errors.user_name?.type === "required" ? "Esse campo é obrigatório." : null
                                            }
                                          </p>
                                          <p>
                                            {
                                              errors.user_name?.type === "validate" ? "O @ é obrigatório antes do seu nome." : null
                                            }
                                          </p>
                                          {
                                            type === "register" && 
                                            (
                                              <p className="max-[450px]:text-xs">
                                                {
                                                  errors.user_name?.type === "minLength" ? "Esse campo deve conter no máximo 5 caracteres." : null
                                                }
                                              </p>
                                            )
                                          }
                        ...
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-12">
                                <label htmlFor="password" className="text-xs font-semibold px-1">Senha</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    ...
                                    <div className="w-full -ml-10">
                                      <input
                                            {...register("password", {
                                              ...
                                              pattern: type === "register" ? regexValidatePassword : undefined,
                                            })}
                                            type="password"
                                            id="password" 
                                            ...
                                            <p>
                                            ...
                                            </p>
                                              {
                                                ...
                                                (
                                                  <p>
                                                    {
                                                      errors?.password?.type === "minLength" && "Esse campo deve conter no máximo 8 caracteres."
                                                    }
                                                  </p>
                                                )
                                              }
                                              {
                                                ...
                                                (
                                                  <p className="max-[450px]:text-xs">
                                                    {
                                                      errors?.password?.type === "pattern" && "Deve ter 1 letra maiúscula e minuscula, números, é caracteres especiais e sem espaços."
                                                    }
                                                  </p>
                                                )
                                              }
                        ...
                        { type === "register" && 
                          (
                            <div className="flex -mx-3">
                              <div className="w-full px-3 mb-12">
                                <label htmlFor="confirme_password" className="text-xs font-semibold px-1">Confirma senha</label>
                                  <div className="flex">
                                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                      <i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                      <div className="w-full -ml-10">
                                          <input 
                                            ...
                                            type="password" 
                                            id="confirme_password" className={`w-full pl-5 pr-3 py-2 rounded-lg border-2 ${errorConfirmPassword} outline-none`}
                                            placeholder="************"
                                          />
                                          <div className="h-2 text-red-500 mb-3 max-[450px]:text-sm">
                                            <p>
                                            ...
                                            <p>
                                              { 
                                                errors?.confirme_password
                                                ?.type === "validate" && "Senha incompatível."
                                              }
                                            </p>
                                          </div>
                                      </div>
                        ...
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                <button type="submit" disabled={isLoad} className={`block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold ${isLoad ? "disabled:opacity-80" : ""}`}>
                                  { isLoad ?
                                    ( <CircleNotch size={24} color="#f1f0ef" className="animate-spin flex justify-center w-full"/> ) 
                    ...
                    <div className="text-center">
                      {
                        ...
                        (
                          <p>
                            ...
                            <Link href="/Login" className="text-blue-500 underline decoration-wavy ml-1">
                              login
                            </Link>
                          </p>
                        )
                        ...
                        (
                          <p>
                            ...
                            <Link href="/Register" className="text-blue-500 underline decoration-wavy ml-1">
                              criar
                            </Link>
                          </p>
                        )
